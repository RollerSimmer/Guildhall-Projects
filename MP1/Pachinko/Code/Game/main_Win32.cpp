...
const int WINDOW_PHYSICAL_SIZE = 800;
const int WINDOW_PHYSICAL_WIDTH = WINDOW_PHYSICAL_SIZE;
const int WINDOW_PHYSICAL_HEIGHT = WINDOW_PHYSICAL_SIZE;
const double VIEW_LEFT = 0.0;
const double VIEW_RIGHT = WORLD_WIDTH;
const double VIEW_BOTTOM = 0.0;
const double VIEW_TOP = WORLD_HEIGHT;
...
const char* APP_NAME = "Pachinko Machine by John Anderson";
...
void CreateOpenGLWindow(HINSTANCE applicationInstanceHandle)
{
	...
	g_theRenderer->setOrthoProjection(Vector2((float)VIEW_LEFT, (float)VIEW_TOP), Vector2((float)VIEW_RIGHT, (float)VIEW_BOTTOM));
