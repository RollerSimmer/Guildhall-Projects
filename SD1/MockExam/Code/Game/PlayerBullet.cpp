...
void PlayerBullet::checkAndProcessEnemyHits()
	{
	//TODO : process enemy bullet hits
// 	EnemyTank* hitTank;
// 	if(g_theMap->doesBulletHitAnyTank(this,hitTank))
// 		{
// 		setHitPoints(0);
// 		int damage=GetRandomIntInRange(PLAYER_BULLET_DAMAGE_TO_ENEMY_SHIP_AVERAGE - PLAYER_BULLET_DAMAGE_DEVIATION,
// 			                           PLAYER_BULLET_DAMAGE_TO_ENEMY_SHIP_AVERAGE + PLAYER_BULLET_DAMAGE_DEVIATION);
// 		hitTank->doDamage(damage);
// 		hitTank->updateEnd(0.f);
// 		g_theApp->getGame()->changeScoreBy(damage);
