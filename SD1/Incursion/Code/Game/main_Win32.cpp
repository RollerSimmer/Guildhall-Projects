...
const float g_screenWidth=(float)WINDOW_PHYSICAL_WIDTH;
const float g_screenHeight=(float)WINDOW_PHYSICAL_HEIGHT;
const double VIEW_LEFT = 0.0;
const double VIEW_RIGHT = g_screenWidth;
const double VIEW_BOTTOM = 0.0;
const double VIEW_TOP = g_screenHeight;
...
const char* APP_NAME = "Incursion Gold by John Anderson";
