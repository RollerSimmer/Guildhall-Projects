...
class Entity
	...
	protected: // members
		...
		bool m_isMoveable;
		bool m_canOverlap;
		bool m_isInvincibleModeActive;
		bool m_isForeverInvincible;
		float m_invincibilityCountdownSeconds;
	...
	public: // accessors
		...
		bool isInvincible() const { return m_isInvincibleModeActive; }
		void toggleEndlessInvincibility();
	...
	public: // methods
		...
		void startTemporaryInvincibility(float durationSeconds);
