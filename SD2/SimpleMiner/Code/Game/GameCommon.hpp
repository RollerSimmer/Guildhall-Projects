...
extern bool g_doHorizonEffect;

constexpr int CHUNK_X_BITS = 2;
constexpr int CHUNK_Y_BITS = 2;
...
constexpr float MAX_GENERATED_HEIGHT_PCT = 1.f;
...
//finite world size
constexpr int FINITE_WORLD_AMT_BLOCKS_XY=2000;
constexpr int FINITE_WORLD_AMT_CHUNKS_X=FINITE_WORLD_AMT_BLOCKS_XY/CHUNK_BLOCKS_X;
constexpr int FINITE_WORLD_AMT_CHUNKS_Y=FINITE_WORLD_AMT_BLOCKS_XY/CHUNK_BLOCKS_Y;

//cities and counties
constexpr int CITY_SQUARE_BLOCKS_XY_BITS	= 4;
constexpr int CITY_SQUARE_BLOCKS_XY			= 1<<CITY_SQUARE_BLOCKS_XY_BITS;
constexpr int CITY_SQUARE_DIMENSION_MASK	= (CITY_SQUARE_BLOCKS_XY-1);
constexpr int CITY_SQUARE_BLOCK_CENTER_XY 	= CITY_SQUARE_BLOCKS_XY/2;
// constexpr int SMALL_CITY_BLOCKS_XY			= CITY_SQUARE_BLOCKS_XY<<2;  
// constexpr int MEDIUM_CITY_BLOCKS_XY			= SMALL_CITY_BLOCKS_XY<<1;
// constexpr int LARGE_CITY_BLOCKS_XY			= MEDIUM_CITY_BLOCKS_XY<<1;
constexpr int LARGE_CITY_BLOCKS_XY			= CITY_SQUARE_BLOCKS_XY<<4;
constexpr int COUNTY_BLOCKS_XY				= LARGE_CITY_BLOCKS_XY<<1;
constexpr int FINITE_WORLD_COUNTIES_XY		= (FINITE_WORLD_AMT_BLOCKS_XY/COUNTY_BLOCKS_XY)+1;
constexpr int CITY_SQUARE_HALF_ROAD_WIDTH	= 1;		// for one half of a road
constexpr int CITY_SQUARE_SIDEWALK_WIDTH	= 1;
constexpr int INTERCITY_ROAD_WIDTH			= CITY_SQUARE_HALF_ROAD_WIDTH*2;		// for one half of a road
